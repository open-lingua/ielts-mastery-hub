  ...
  sections: [
    {
      ...
      questions: [
        ...
        },
        {
          id: "s1q4",
          type: "fill",
          text: "Type of accommodation: ___",
          answer: "shared flat",
          wordLimit: 2,
        },
        {
          id: "s1q5",
          type: "fill",
          text: "Maximum loan period for reference books: ___ days",
          answer: "3",
          wordLimit: 1,
        },
        {
        ...
        },
        {
          id: "s1q8",
          type: "fill",
          text: "The fine for overdue books is ___ per day.",
          answer: "£0.50",
          wordLimit: 1,
        },
        {
          id: "s1q9",
          type: "fill",
          text: "The student's email address is: ___@unimail.ac.uk",
          answer: "j.blackwell",
          wordLimit: 2,
        },
        {
          id: "s1q10",
          type: "fill",
          text: "The library card will be ready by ___.",
          answer: "Friday",
          wordLimit: 1,
        },
      ],
      ...
      questions: [
        ...
        },
        {
          ...
          options: [
            ...
            "The tour is rescheduled free of charge",
          ],
      ...
      questions: [
        {
          id: "s4q1",
          type: "fill",
          text: "The lecture defines cognitive bias as a systematic pattern of ___ from rationality.",
          answer: "deviation",
          wordLimit: 2,
        },
        {
          id: "s4q2",
          type: "fill",
          text: "The 'anchoring effect' causes people to rely too heavily on the first piece of ___ they receive.",
          answer: "information",
          wordLimit: 2,
        },
        {
        ...
        },
        {
          id: "s4q4",
          type: "fill",
          text: "Confirmation bias leads people to seek evidence that ___ their existing beliefs.",
          answer: "supports",
          wordLimit: 2,
        },
        {
          id: "s4q5",
          type: "fill",
          text: "The 'sunk cost fallacy' makes people continue investing in a project because of ___ spent.",
          answer: "resources already",
          wordLimit: 2,
        },
        {
          id: "s4q6",
        ...
        },
        {
          id: "s4q7",
          type: "fill",
          text: "Studies show that people make approximately ___ decisions per day.",
          answer: "35,000",
          wordLimit: 1,
        },
        {
        ...
        },
        {
          id: "s4q9",
          type: "fill",
          text: "The concept of 'bounded rationality' was introduced by Herbert ___.",
          answer: "Simon",
          wordLimit: 1,
        },
        {
          id: "s4q10",
          type: "fill",
          text: "The lecture concludes that awareness of biases can improve decision ___ significantly.",
          answer: "quality",
          wordLimit: 2,
        },
      ],
