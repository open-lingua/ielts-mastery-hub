...
pub async fn get_writing_tests(
    ...
    id: String,
    user_id: String,
) -> Result<Option<WritingTest>, String> {
...
#[tauri::command]
pub async fn list_writing_tests(
    db: State<'_, Db>,
    user_id: String,
) -> Result<Vec<WritingTest>, String> {
    repo::find_all(&db, &user_id).await.map_err(Into::into)
}

#[tauri::command]
pub async fn create_writing_tests(
    db: State<'_, Db>,
    user_id: String,
...
#[tauri::command]
pub async fn update_writing_tests(
    db: State<'_, Db>,
    id: String,
    user_id: String,
...
#[tauri::command]
pub async fn delete_writing_tests(
    db: State<'_, Db>,
    id: String,
    user_id: String,
) -> Result<(), String> {
