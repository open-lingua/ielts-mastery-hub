...
use crate::repositories::listening_question_groups::{
...
pub async fn get_listening_question_groups(
    ...
    id: String,
    user_id: String,
) -> Result<Option<ListeningQuestionGroup>, String> {
...
#[tauri::command]
pub async fn list_listening_question_groups(
    db: State<'_, Db>,
    user_id: String,
) -> Result<Vec<ListeningQuestionGroup>, String> {
    repo::find_all(&db, &user_id).await.map_err(Into::into)
}

#[tauri::command]
pub async fn create_listening_question_groups(
    db: State<'_, Db>,
    user_id: String,
...
#[tauri::command]
pub async fn update_listening_question_groups(
    db: State<'_, Db>,
    id: String,
    user_id: String,
...
#[tauri::command]
pub async fn delete_listening_question_groups(
    db: State<'_, Db>,
    id: String,
    user_id: String,
) -> Result<(), String> {
