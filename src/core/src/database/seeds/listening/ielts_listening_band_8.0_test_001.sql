...
('29a6cdce-ac6b-4be4-83ad-63e123ba694a', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 1,
 'Company Name: ________ Associates', 'Sterling', '["Sterling","sterling","STERLING"]'),
('0363865a-e441-414e-bd64-c9214c9db708', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 2,
 'Agreed arrival date: ________', '27th October', '["27th October","27 October","October 27th","27th of October"]'),
('0c2463a1-8a2a-452d-a2f6-5b6b5178184d', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 3,
 'Total agreed cost: £________', '1450', '["1450","1,450","1450 pounds"]'),
('2abc74c3-5e33-43a4-b1f8-e4188590dcc3', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 4,
 'Extra equipment required: ________', 'projector', '["projector","a projector","Projector"]'),
('185ed0fa-ec8e-4ebf-bc2a-b6666728aab6', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 5,
 'Catering request: All food must be ________', 'vegetarian', '["vegetarian","Vegetarian"]'),
('1a2c2c2f-66ef-49ad-b0ff-423d40fc0edf', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 6,
 'Included in the hire price: ________', 'parking', '["parking","secure parking","Parking"]'),
('f40c31db-156d-46f7-a0da-b06e25b314c4', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 7,
 'Accommodation feature: Rooms have a private ________', 'balcony', '["balcony","Balcony"]'),
('23425002-d5df-44db-87d0-81d43c5575b8', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 8,
 'Must provide a copy of their ________', 'insurance', '["insurance","liability insurance","corporate insurance"]'),
('78fa83f9-6eaa-472d-9445-cf895ea91bb4', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 9,
 'Client''s direct mobile number: ________', '07844 299 011', '["07844 299 011","07844299011"]'),
('9ac96cd1-6ada-4fd5-b124-d91fad20cd2b', 'b2fd973c-9c11-4034-8059-8b6f4a22ead6', 10,
 'Final step to secure booking: Pay a ________', 'deposit', '["deposit","Deposit"]');
...
('01cc79c8-87b8-46f7-ab6e-ae66b16d900f', 'f91b6bc4-7435-4471-9f95-bfdf4aa1976b', 11,
 ...
 '["A. Severe weather damaged the trails", "B. They lacked sufficient funding", "C. They were waiting for official documentation"]', 'C'),
('869d1e08-85b3-470e-a70f-ebd40efdc8b9', 'f91b6bc4-7435-4471-9f95-bfdf4aa1976b', 12,
 ...
 '["A. To promote eco-tourism", "B. To breed endangered bird species", "C. To conduct academic ecological research"]', 'B'),
('0d154ecb-238b-4e2e-a36a-c19e4282f947', 'f91b6bc4-7435-4471-9f95-bfdf4aa1976b', 13,
 'What strict rule must all visitors follow?',
 '["A. Do not take photographs near nests", "B. Do not consume food on the premises", "C. Do not leave the designated pathways"]', 'C'),
('f131d76f-2237-4b46-a8d4-b1fcc618a99b', 'f91b6bc4-7435-4471-9f95-bfdf4aa1976b', 14,
 'What service is available at the Gift Shop?',
 '["A. Booking guided tours", "B. Equipment hire", "C. Buying hot meals"]', 'B'),
('8cead764-0b72-4422-b38c-7b95b4e1aff9', 'f91b6bc4-7435-4471-9f95-bfdf4aa1976b', 15,
 'How is the reserve primarily funded?',
 '["A. Through government grants", "B. By corporate sponsorships", "C. Through contributions from the public"]', 'C');
...
('d55bae8f-45d1-4b2d-ae09-1fde5029702a', '5a5e2ea9-ad90-4df0-828a-0284fc38211e', 21,
 ...
 '["A. defining what a smart city is", "B. standardising the data metrics", "C. finding reliable sources"]', 'B'),
('82e33eec-fca2-4ce5-b3e7-5165ecfa9353', '5a5e2ea9-ad90-4df0-828a-0284fc38211e', 22,
 ...
 '["A. reduced commute times", "B. lower carbon emissions", "C. fewer pedestrian accidents"]', 'C'),
('09093725-eaf8-4e08-887b-25b280a3cd20', '5a5e2ea9-ad90-4df0-828a-0284fc38211e', 23,
 ...
 '["A. Shorten the historical context section", "B. Expand the section on funding models", "C. Include more case studies"]', 'A'),
('931ec8db-d224-4637-873b-0801622de910', '5a5e2ea9-ad90-4df0-828a-0284fc38211e', 24,
 ...
 '["A. public trust in autonomous vehicles will grow slowly", "B. cost savings will force the adoption of driverless buses", "C. rail networks will receive more funding than buses"]', 'B'),
('8e3ee876-c1ee-4810-849f-61e7585d0912', '5a5e2ea9-ad90-4df0-828a-0284fc38211e', 25,
 ...
 '["A. The environmental benefits of smart tech", "B. The threat of mass surveillance and privacy loss", "C. The economic cost of implementation"]', 'B');
...
('4fbb52c6-2a04-47ca-b442-4358e02f48a5', '816f4c76-2624-45ad-8ea6-6035faca2e2a', 26,
 'Singapore', '["A. Predictive policing", "B. Digital voting apps", "C. Pneumatic waste disposal", "D. Dynamic toll pricing", "E. Automated energy grids", "F. Sensor-driven water management"]', 'D'),
('9ef4b294-7962-4db0-81b0-6f658a2c0735', '816f4c76-2624-45ad-8ea6-6035faca2e2a', 27,
 'Copenhagen', '["A. Predictive policing", "B. Digital voting apps", "C. Pneumatic waste disposal", "D. Dynamic toll pricing", "E. Automated energy grids", "F. Sensor-driven water management"]', 'F'),
('5db03547-e025-4f12-9e2e-ca055c4d8327', '816f4c76-2624-45ad-8ea6-6035faca2e2a', 28,
 'Songdo', '["A. Predictive policing", "B. Digital voting apps", "C. Pneumatic waste disposal", "D. Dynamic toll pricing", "E. Automated energy grids", "F. Sensor-driven water management"]', 'C'),
('b4035519-be52-44ba-ac4b-0a6f1245462a', '816f4c76-2624-45ad-8ea6-6035faca2e2a', 29,
 'Amsterdam', '["A. Predictive policing", "B. Digital voting apps", "C. Pneumatic waste disposal", "D. Dynamic toll pricing", "E. Automated energy grids", "F. Sensor-driven water management"]', 'A'),
('96fc311c-b098-48b2-ab46-3446d57cbdff', '816f4c76-2624-45ad-8ea6-6035faca2e2a', 30,
 'Helsinki', '["A. Predictive policing", "B. Digital voting apps", "C. Pneumatic waste disposal", "D. Dynamic toll pricing", "E. Automated energy grids", "F. Sensor-driven water management"]', 'B');
...
('ba645da4-1a66-4b87-a705-699dbbd132e1', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 31,
 'Most plant remains survive by being burnt and turning into ________.', 'charcoal', '["charcoal","Charcoal"]'),
('0c194ae4-2d29-42af-b9b2-a2f4ec58df5d', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 32,
 'Waterlogged sites preserve organics due to a complete lack of ________.', 'oxygen', '["oxygen","Oxygen"]'),
('4399ad21-101f-4d50-969b-f11d9b0811c5', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 33,
 'Domesticated wheat is identified by its much tougher ________.', 'stem', '["stem","Stem"]'),
('c07142be-313b-4e0c-8069-33081db9cff4', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 34,
 'Increases in seed size led to the creation of new tools for ________.', 'harvesting', '["harvesting","Harvesting"]'),
('66229809-e5dc-4bab-9d15-f9580c57c34d', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 35,
 'The presence of specific ________ provides clues about ancient soil quality.', 'weeds', '["weeds","Weeds"]'),
('b67e6677-7668-4705-9784-b3d9cb32f585', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 36,
 'Chemical isotopes in crops can prove the early use of ________.', 'irrigation', '["irrigation","Irrigation"]'),
('3c2ec745-a5f0-49ac-bcdb-d38b209966e4', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 37,
 'Pollen analysis is used by researchers to reconstruct the past ________.', 'climate', '["climate","Climate"]'),
('2a52d639-e1a2-4db9-9811-99f3846ff447', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 38,
 'Fossilised human faeces reveal the exact contents of the ________.', 'stomach', '["stomach","Stomach"]'),
('907d62b7-36f0-4f0b-9381-fb3cc564d646', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 39,
 'The discovery of exotic plant species offers proof of long-distance ________.', 'trade', '["trade","Trade"]'),
('7008a1b3-31c1-45c6-8ea6-dd873dc2104f', '06b2ae83-06b6-4a32-9605-1a88d7c5fc41', 40,
 'A modern ________ is an essential tool for seeing cellular details.', 'microscope', '["microscope","Microscope"]');
