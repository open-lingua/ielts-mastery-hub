...
/// Builder for `CreateListeningQuestionGroup`.
pub struct CreateListeningQuestionGroupBuilder {
    section_id: String,
...
impl Default for CreateListeningQuestionGroupBuilder {
    fn default() -> Self {
        Self {
            section_id: "placeholder-section-id".to_string(),
...
impl CreateListeningQuestionGroupBuilder {
    pub fn with_section_id(mut self, section_id: &str) -> Self {
        self.section_id = section_id.to_string();
        self
    }
    ...
    pub fn build(self) -> CreateListeningQuestionGroup {
...
/// Builder for `UpdateListeningQuestionGroup`. Every field starts as `None`, meaning
/// "no change" per the repository's `COALESCE` update semantics.
#[derive(Default)]
pub struct UpdateListeningQuestionGroupBuilder {
    group_order: Option<i64>,
    question_type: Option<String>,
    instructions: Option<String>,
    word_limit: Option<String>,
...
impl UpdateListeningQuestionGroupBuilder {
    pub fn with_group_order(mut self, group_order: i64) -> Self {
        self.group_order = Some(group_order);
        self
    }
    ...
    pub fn build(self) -> UpdateListeningQuestionGroup {
