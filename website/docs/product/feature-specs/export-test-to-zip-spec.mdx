---
sidebar_position: 1
title: "Feature Spec: Export Test to ZIP"
---

# Feature Spec: Export Test to ZIP

Full reproduction of `docs/spec/export-test-to-zip.md` — this page is the canonical template structure for all future feature specs added under `product/feature-specs/`.
...
This feature has **shipped** (see `1.0.0-beta.8` in `RELEASES.md`) — see [Exporting Tests as ZIP Archives](../../admin/export-test-to-zip.mdx) for how the implementation maps onto this spec, and [Adding a New Feature End-to-End](../../contributing/adding-a-new-feature.mdx) for the real commit-by-commit build sequence.
