...
('579a7f52-ff12-4e2e-bea8-063b47c8e2c1', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 1,
 'Confirmed Venue: The ________', 'Maritime Museum', '["Maritime Museum","maritime museum","Maritime museum"]'::jsonb),
('0c451d1d-0310-4dd4-b960-05e9d0bde6eb', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 2,
 'Final Date: ________ November', '15th', '["15th","15","15th of"]'::jsonb),
('20331179-0925-4f11-a212-f61c7fa0e198', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 3,
 'Total confirmed attendees: ________', '118', '["118","one hundred and eighteen"]'::jsonb),
('c22481d6-3fd6-41bd-9a53-400ec1c2be78', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 4,
 'Catering Package selected: ________', 'Platinum', '["Platinum","platinum","Platinum package"]'::jsonb),
('a4612d34-c7a8-4a29-8903-7d267b6d8dfd', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 5,
 'Strict dietary isolation required for: ________ disease', 'celiac', '["celiac","Celiac","coeliac"]'::jsonb),
('3eeee934-c074-4bb7-be91-16aac501ce74', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 6,
 'Included at no extra charge: Dedicated ________', 'security', '["security","Security"]'::jsonb),
('5f4130a9-72e7-4fd1-a913-865f9b7f2bd7', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 7,
 'Client will provide their own ________', 'lighting rig', '["lighting rig","lighting","Lighting rig"]'::jsonb),
('b862175f-b457-4a83-abc5-7d5d4f0cef4f', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 8,
 'Production contact name: ________', 'Alastair', '["Alastair","alastair"]'::jsonb),
('e513a741-7c58-404b-b7bd-1111e28f23f4', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 9,
 'Contact mobile number: ________', '07789 544 321', '["07789 544 321","07789544321"]'::jsonb),
('3587fab5-093e-4693-bf73-4376664896de', '4c1132cf-6a3a-4c17-b027-8ec370297f3c', 10,
 'Must be submitted by Friday: An evening ________', 'itinerary', '["itinerary","Itinerary"]'::jsonb);
...
('1c7aff66-2055-4d51-bd5b-3352159cbf2c', '9cfe374f-4524-46b1-b76e-72c91fd4dd88', 11,
 ...
 '["A. Severe budgetary constraints", "B. A lack of specialized construction equipment", "C. The retreating coastline"]'::jsonb, 'C'),
('b34342c4-6241-4f03-bf18-5191aaa618af', '9cfe374f-4524-46b1-b76e-72c91fd4dd88', 12,
 ...
 '["A. catalog new biological species", "B. develop new biomedical treatments", "C. sequence the genomes of deep-sea fish"]'::jsonb, 'B'),
('d86c7c03-113f-40d6-94e2-0d998d45c3ec', '9cfe374f-4524-46b1-b76e-72c91fd4dd88', 13,
 ...
 '["A. They must wear protective clothing", "B. They must not use flash photography", "C. They must remain completely silent"]'::jsonb, 'B'),
('9097ca6c-03a8-4dc2-811a-b9b0ae2b89b9', '9cfe374f-4524-46b1-b76e-72c91fd4dd88', 14,
 'The Data Processing Hub is notable for being',
 '["A. heavily air-conditioned", "B. completely soundproof", "C. powered by solar energy"]'::jsonb, 'A'),
('beb5b74b-f15f-4e71-a22b-979a6cf802ac', '9cfe374f-4524-46b1-b76e-72c91fd4dd88', 15,
 ...
 '["A. To protect it from extreme weather", "B. To prevent the risk of contamination", "C. To secure highly classified documents"]'::jsonb, 'B');
...
('0b3da90e-d0be-4041-9060-c5ea000f70cf', '25625ee9-39fe-4cb0-91e2-6d972a8b4174', 21,
 ...
 '["A. narrowing down the project scope", "B. standardizing inconsistent statistical data", "C. securing access to government documents"]'::jsonb, 'B'),
('eeb4150b-2291-4e75-b129-2c1ea7aa51ef', '25625ee9-39fe-4cb0-91e2-6d972a8b4174', 22,
 ...
 '["A. financial incentives were largely ineffective", "B. younger demographics resisted registration", "C. the default opt-out mechanism was the most successful"]'::jsonb, 'C'),
('cfea2452-a497-428b-9182-ed39803be6ca', '25625ee9-39fe-4cb0-91e2-6d972a8b4174', 23,
 ...
 '["A. Expand the theoretical framework", "B. Reduce the historical context of classical economics", "C. Introduce more varied case studies"]'::jsonb, 'B'),
('a7cbddbe-fb43-416e-b7b3-e0e079eeff0a', '25625ee9-39fe-4cb0-91e2-6d972a8b4174', 24,
 ...
 '["A. transparency regulations will eventually succeed", "B. tech companies will evade legislative restrictions due to profit motives", "C. users will naturally develop resistance to psychological manipulation"]'::jsonb, 'B'),
('c3c67c1b-efdb-4d26-8678-c87064368f55', '25625ee9-39fe-4cb0-91e2-6d972a8b4174', 25,
 ...
 '["A. is a highly effective tool for economic efficiency", "B. relies too heavily on psychological manipulation", "C. threatens individual autonomy without democratic oversight"]'::jsonb, 'C');
...
('1efad00c-e295-4881-a37b-888a099c0f7b', 'efcda95a-be9c-4a82-93a2-47d4eef2dab4', 26,
 'Charity donation page layouts', '["A. Anchoring Effect", "B. Loss Aversion", "C. Confirmation Bias", "D. Decoy Effect", "E. Halo Effect", "F. Status Quo Bias"]'::jsonb, 'A'),
('00b6669b-866c-4244-bafa-dd228d470ee7', 'efcda95a-be9c-4a82-93a2-47d4eef2dab4', 27,
 'Retail discount countdown timers', '["A. Anchoring Effect", "B. Loss Aversion", "C. Confirmation Bias", "D. Decoy Effect", "E. Halo Effect", "F. Status Quo Bias"]'::jsonb, 'B'),
('d7b359d3-421a-4daa-ade1-f2c217e2f33c', 'efcda95a-be9c-4a82-93a2-47d4eef2dab4', 28,
 'Political echo chambers on social media', '["A. Anchoring Effect", "B. Loss Aversion", "C. Confirmation Bias", "D. Decoy Effect", "E. Halo Effect", "F. Status Quo Bias"]'::jsonb, 'C'),
('4910061e-e2ec-4840-9af1-0010e43eef22', 'efcda95a-be9c-4a82-93a2-47d4eef2dab4', 29,
 'Magazine subscription pricing models', '["A. Anchoring Effect", "B. Loss Aversion", "C. Confirmation Bias", "D. Decoy Effect", "E. Halo Effect", "F. Status Quo Bias"]'::jsonb, 'D'),
('3b529485-5a46-4824-adc5-646de91484fa', 'efcda95a-be9c-4a82-93a2-47d4eef2dab4', 30,
 'A tech CEO''s charismatic public persona', '["A. Anchoring Effect", "B. Loss Aversion", "C. Confirmation Bias", "D. Decoy Effect", "E. Halo Effect", "F. Status Quo Bias"]'::jsonb, 'E');
...
('38a57fc4-98f5-4b15-9db5-cb0ed43b46ce', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 31,
 'Before becoming solid ice, compressed snow transforms into a material known as ________.', 'firn', '["firn","Firn"]'::jsonb),
('18ba98bf-ea03-48dc-94fd-75874ed5a6cc', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 32,
 'Pristine samples of ancient air are preserved inside permanently trapped ________.', 'bubbles', '["bubbles","air bubbles","Bubbles"]'::jsonb),
('fb1a947e-1105-4356-85bd-fb86e5dac17c', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 33,
 'To reconstruct historical global temperatures, scientists primarily analyze the ratio of ________.', 'oxygen isotopes', '["oxygen isotopes","Oxygen isotopes"]'::jsonb),
('ec8a01b4-f712-433f-baeb-bac703c394ff', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 34,
 'A lower concentration of oxygen-18 indicates that the climate was ________.', 'colder', '["colder","Colder"]'::jsonb),
('9d7e82af-a02c-4c59-bfc5-8941fce989f3', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 35,
 'Layers of volcanic ash act as highly useful ________ for aligning different core samples.', 'synchronous markers', '["synchronous markers","markers","Synchronous markers"]'::jsonb),
('d022e388-be50-42fb-9c29-3be7260e6961', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 36,
 'Levels of beryllium-10 help track historical changes in the Earth''s ________.', 'magnetic field', '["magnetic field","Magnetic field"]'::jsonb),
('b0aa193e-1db2-45a5-b9a2-c172766efb31', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 37,
 'Increases in terrestrial dust and sea salt indicate a period of intensified ________.', 'wind patterns', '["wind patterns","Wind patterns","global wind"]'::jsonb),
('ddc87d35-f664-4f2d-86b5-a98f4b8f2367', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 38,
 'During transit, cores are kept at strict sub-zero temperatures to avoid structural ________.', 'degradation', '["degradation","Degradation"]'::jsonb),
('4429bc67-1356-4d47-a6b9-f4a661e41ab2', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 39,
 'Deep ice under extreme pressure is susceptible to ________, which ruins data.', 'brittle failure', '["brittle failure","Brittle failure","fracturing"]'::jsonb),
('08627b2a-9b4c-40a5-9383-6e9cbafa4744', '1bc1e7e5-0c1d-41eb-88f8-9f405eaf7a54', 40,
 'Because gas is younger than the surrounding ice, data interpretation requires sophisticated ________.', 'modeling', '["modeling","modelling","Modeling","Modelling"]'::jsonb);
