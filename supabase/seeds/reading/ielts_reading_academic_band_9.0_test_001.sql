...
('26216a82-fa54-4328-a481-c7de928aa74d', 'c260a70a-88d5-4f54-8986-126bf0937a9d', 1,
 'The Rosetta Stone was utilized by François Desset to translate Linear Elamite.', 'FALSE', '["FALSE","False","false"]'::jsonb),
('e8112125-5666-49fc-b7df-2cea1ebd290d', 'c260a70a-88d5-4f54-8986-126bf0937a9d', 2,
 'The surviving examples of Linear Elamite inscriptions were statistically limited.', 'TRUE', '["TRUE","True","true"]'::jsonb),
('2e2fba74-4bff-4581-ac53-66f22204cb7f', 'c260a70a-88d5-4f54-8986-126bf0937a9d', 3,
 'The decipherment proved that writing originated exclusively in southern Mesopotamia.', 'FALSE', '["FALSE","False","false"]'::jsonb),
('b765cb8a-5b65-46f3-9a66-2cdc0520efa1', 'c260a70a-88d5-4f54-8986-126bf0937a9d', 4,
 'Linear Elamite was predominantly used for agricultural accounting.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb);
...
('13422d6e-8903-491a-befe-bfb1922a1d04', '63eb35e0-ffec-4c1e-9d62-09b686b11ddb', 5,
 'Row 1', '',
 '[{"id":"h1","gapText":"Script Type","answer":""},{"id":"h2","gapText":"Key Characteristic","answer":""},{"id":"h3","gapText":"Primary Region","answer":""}]'::jsonb),
('babd47f8-d469-4945-9e90-d92e9db23a89', '63eb35e0-ffec-4c1e-9d62-09b686b11ddb', 6,
 'Row 2', '',
 '[{"id":"c1","gapText":"Mesopotamian Cuneiform","answer":""},{"id":"c2","gapText":"","answer":"heavily logophonetic"},{"id":"c3","gapText":"Mesopotamia","answer":""}]'::jsonb),
('cc978717-fed0-458c-8813-5eb7e248173f', '63eb35e0-ffec-4c1e-9d62-09b686b11ddb', 7,
 'Row 3', '',
 '[{"id":"c4","gapText":"Linear Elamite","answer":""},{"id":"c5","gapText":"Almost entirely {{gap}}","answer":"phonetic"},{"id":"c6","gapText":"Southwestern Iran","answer":""}]'::jsonb),
('836ad13b-169e-4b77-9fae-1dd573fa1f84', '63eb35e0-ffec-4c1e-9d62-09b686b11ddb', 8,
 'Row 4', '',
 '[{"id":"c7","gapText":"Linear Elamite translated via","answer":""},{"id":"c8","gapText":"","answer":"silver beakers"},{"id":"c9","gapText":"Kamtiri region","answer":""}]'::jsonb),
('bcbdd48f-0b0f-4416-8818-b1e657be0d9c', '63eb35e0-ffec-4c1e-9d62-09b686b11ddb', 9,
 'Row 5', '',
 '[{"id":"c10","gapText":"Original fragment discoveries","answer":""},{"id":"c11","gapText":"Fragmentary inscriptions","answer":""},{"id":"c12","gapText":"Ancient metropolis of {{gap}}","answer":"Susa"}]'::jsonb);
...
('e16994cf-58be-462f-91c2-9dfee08f7e52', 'd9f16e54-1bb2-433f-a23b-ed160b9366b6', 10,
 'What type of texts were notoriously lacking, hindering early decipherment efforts?', 'bilingual texts', '[{"id":"1","text":"bilingual texts"},{"id":"2","text":"bilingual"}]'::jsonb),
('fdcffd8d-1440-407f-b211-797b8258f146', 'd9f16e54-1bb2-433f-a23b-ed160b9366b6', 11,
 'What specific term refers to the artifacts that ultimately provided the phonetic anchor?', 'gunagi vessels', '[{"id":"1","text":"gunagi vessels"},{"id":"2","text":"gunagi"}]'::jsonb),
('e732deef-354d-4d9a-9a29-9ffb4ccecbb8', 'd9f16e54-1bb2-433f-a23b-ed160b9366b6', 12,
 'How many signs approximately did the Linear Elamite writing system utilize?', '80 to 100', '[{"id":"1","text":"80 to 100"},{"id":"2","text":"80-100"}]'::jsonb),
('c5587695-a159-4e68-90f7-1891b4cd2b45', 'd9f16e54-1bb2-433f-a23b-ed160b9366b6', 13,
 'How is the Elamite language classified linguistically by modern epigraphers?', 'language isolate', '[{"id":"1","text":"language isolate"},{"id":"2","text":"a language isolate"}]'::jsonb);
...
('97374222-0209-475c-9723-70b930c31b41', 'a48fe0af-5503-4ab4-9393-d5396c7c53ee', 1,
 ...
 true, '["i. The biological limitations of data processing","ii. Operant conditioning in user interface design","iii. Evaluating the societal and neurobiological toll","iv. Legislative efforts toward cognitive protection","v. The commodification of behavioral predictions","vi. A historical oversight in psychological research","vii. The foundational theory of information abundance","viii. Algorithms designed for educational enhancement"]'::jsonb);
...
('55197073-7d33-4cb1-938c-9a213e9f2c14', '4d1c3bc0-fa49-4986-9368-38f86ff12097', 27,
 ...
 'A',
 '[{"id":"A","text":"A. Shifting corporate metrics from engagement duration to user well-being.","isCorrect":true},{"id":"B","text":"B. Enhancing the variable ratio schedules used in platform interfaces.","isCorrect":false},{"id":"C","text":"C. Rejecting all forms of European technological regulation.","isCorrect":false},{"id":"D","text":"D. Acknowledging that information abundance is fundamentally irreversible.","isCorrect":false}]'::jsonb);
...
('c3f336c5-6559-4254-863a-3fa6413ce801', '73dbee06-dd9e-425e-ab1f-7a8f6ca90d6e', 28,
 'Classical biochemists initially believed that a living organism''s internal environment would destroy quantum states.', 'YES', '["YES","Yes","yes"]'::jsonb),
('331fd6c2-fc1c-4fbc-b4a1-4a3a85777910', '73dbee06-dd9e-425e-ab1f-7a8f6ca90d6e', 29,
 'The cryptochrome protein relies on sound vibrations to maintain its quantum entanglement.', 'NO', '["NO","No","no"]'::jsonb),
('8d1e8678-016e-4f57-8d8c-9d7ef53e32bd', '73dbee06-dd9e-425e-ab1f-7a8f6ca90d6e', 30,
 'Energy transfer in the FMO complex can be adequately explained by the classical "drunkard''s walk" model.', 'NO', '["NO","No","no"]'::jsonb),
('184c145b-5df2-482a-bedc-1a328afddd53', '73dbee06-dd9e-425e-ab1f-7a8f6ca90d6e', 31,
 'Quantum tunneling is primarily responsible for preventing detrimental DNA mutations in humans.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb),
('c0b3c3bb-1ca2-4048-bcd1-b7f947b32f5a', '73dbee06-dd9e-425e-ab1f-7a8f6ca90d6e', 32,
 'The vibration theory of olfaction proposes that receptors measure an odorant''s molecular vibrational frequency.', 'YES', '["YES","Yes","yes"]'::jsonb);
...
('150caf5f-f4dc-424d-b001-99c64eefcf73', '41b97e01-0914-47e2-b751-b6cbeb56bb68', 3,
 ...
 true, '["entanglement","coherence","tunneling","anomalies","spectrometers","vibrational","thermodynamics"]'::jsonb);
