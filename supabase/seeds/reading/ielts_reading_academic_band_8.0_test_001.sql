...
('11a8b648-8133-4009-9953-7f059e74df4c', '1a71c25b-36fd-4f36-b1a5-45602449906e', 1,
 'The sponge divers immediately recognised the scientific significance of the bronze mechanism in 1901.', 'FALSE', '["FALSE","False","false"]'::jsonb),
('421d8522-6065-4d19-b6c6-442f7e2b1946', '1a71c25b-36fd-4f36-b1a5-45602449906e', 2,
 'Early historians believed the ancient Greeks were incapable of producing such precise metallurgical engineering.', 'TRUE', '["TRUE","True","true"]'::jsonb),
('76e9f27a-f022-4564-b3c2-bad5199e6b60', '1a71c25b-36fd-4f36-b1a5-45602449906e', 3,
 'Derek de Solla Price built a fully functioning physical replica of the device to prove his theories.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb),
('0be1ca32-adfa-4bbb-b21f-515a3daead40', '1a71c25b-36fd-4f36-b1a5-45602449906e', 4,
 'The device incorporated mathematical theories regarding the variable speed of the moon.', 'TRUE', '["TRUE","True","true"]'::jsonb);
...
('e1152689-f4c9-43aa-a410-b3802e1fb277', 'b6dd143f-4e08-41ef-869b-48a206d0967e', 5,
 'Row 1', '',
 '[{"id":"c1","gapText":"1902","answer":""},{"id":"c2","gapText":"Valerios Stais","answer":""},{"id":"c3","gapText":"Identified a","answer":"gear wheel"},{"id":"c4","gapText":"inside the rock","answer":""}]'::jsonb),
('17b2f7ee-9321-4f2d-87fc-35e6d7b1f0ac', 'b6dd143f-4e08-41ef-869b-48a206d0967e', 6,
 'Row 2', '',
 '[{"id":"c5","gapText":"1970s","answer":""},{"id":"c6","gapText":"Derek de Solla Price","answer":""},{"id":"c7","gapText":"Used early X-ray imaging to count the","answer":"gear teeth"}]'::jsonb),
('9805928c-6982-41a7-9d65-9ccf9fa4fd67', 'b6dd143f-4e08-41ef-869b-48a206d0967e', 7,
 'Row 3', '',
 '[{"id":"c8","gapText":"2005","answer":""},{"id":"c9","gapText":"AMRP","answer":""},{"id":"c10","gapText":"Employed microfocus","answer":"X-ray tomography"},{"id":"c11","gapText":"to view internal fragments","answer":""}]'::jsonb),
('5ec77174-841e-434a-a3d5-e6ead9223d2b', 'b6dd143f-4e08-41ef-869b-48a206d0967e', 8,
 'Row 4', '',
 '[{"id":"c12","gapText":"1st Century BC","answer":""},{"id":"c13","gapText":"Romans","answer":""},{"id":"c14","gapText":"Looted the device during their expanding","answer":"Roman conquest"},{"id":"c15","gapText":"of the Mediterranean","answer":""}]'::jsonb);
...
('36844375-2571-4a0d-9f72-832c78d57775', '01e67076-4ecb-45f8-aa87-1bc4c691f158', 9,
 'What specific celestial cycle did the mechanism utilise to predict eclipses?', 'Saros cycle', '[{"id":"1","text":"Saros cycle"},{"id":"2","text":"the Saros cycle"}]'::jsonb),
('9f42a10d-fa1f-45e9-b112-e662771eb456', '01e67076-4ecb-45f8-aa87-1bc4c691f158', 10,
 'Which eminent Greek astronomer is most commonly theorised to be the device''s creator?', 'Hipparchus', '[{"id":"1","text":"Hipparchus"}]'::jsonb),
('bd570036-c7d8-48d2-9263-fbb9685f495e', '01e67076-4ecb-45f8-aa87-1bc4c691f158', 11,
 'What was the primary material the device was originally manufactured from?', 'bronze', '[{"id":"1","text":"bronze"}]'::jsonb),
('d23851c2-d528-4186-adcb-6994e643e7ed', '01e67076-4ecb-45f8-aa87-1bc4c691f158', 12,
 'During which later historical period did comparable mechanical complexity finally reappear in Europe?', 'European Renaissance', '[{"id":"1","text":"European Renaissance"},{"id":"2","text":"the European Renaissance"}]'::jsonb),
('cb1cbcf7-cc34-4ded-83f0-aaa007d0f1c9', '01e67076-4ecb-45f8-aa87-1bc4c691f158', 13,
 'What type of ancient vessel was likely transporting the mechanism when it sank?', 'Roman vessel', '[{"id":"1","text":"Roman vessel"},{"id":"2","text":"a Roman vessel"}]'::jsonb);
...
('676b98a2-2f66-47e8-bd59-bed6dbaf7d38', 'b4d8c216-1a13-427d-9c73-74192f147d5a', 25,
 ...
 'B',
 '[{"id":"A","text":"A. an uncontrollable overgrowth of fungal hyphae.","isCorrect":false},{"id":"B","text":"B. plants actively ceasing to feed their microbial partners.","isCorrect":true},{"id":"C","text":"C. an immediate and permanent collapse of all crop yields.","isCorrect":false},{"id":"D","text":"D. the physical destruction of the soil''s geometric structure.","isCorrect":false}]'::jsonb),
...
('5bfac454-784a-4196-8518-fc95b777c6e1', 'b4d8c216-1a13-427d-9c73-74192f147d5a', 27,
 ...
 'D',
 '[{"id":"A","text":"A. To argue strictly against all forms of modern technological agriculture.","isCorrect":false},{"id":"B","text":"B. To calculate the economic benefits of reducing synthetic fertiliser usage.","isCorrect":false},{"id":"C","text":"C. To detail the exhaustive history of farming practices since the industrial revolution.","isCorrect":false},{"id":"D","text":"D. To highlight the profound ecological importance of the soil microbiome and its restoration.","isCorrect":true}]'::jsonb);
...
('89d83dbe-6ffd-4fa0-bc3e-b41a9e48352a', 'ba3b8170-bfac-464f-8b47-6e96a5aca976', 28,
 'Benjamin Libet''s experiments proved unequivocally that humans have absolutely no control over their actions.', 'NO', '["NO","No","no"]'::jsonb),
('6f80aa1a-fe04-474f-bf13-35444d09926a', 'ba3b8170-bfac-464f-8b47-6e96a5aca976', 29,
 'Daniel Wegner argued that the conscious will is merely an afterthought rather than a driving force of action.', 'YES', '["YES","Yes","yes"]'::jsonb),
('5d92cf4d-519e-42a4-846e-a8d8d4f9ed9f', 'ba3b8170-bfac-464f-8b47-6e96a5aca976', 30,
 'John-Dylan Haynes''s research contradicted the core findings of Libet''s original EEG experiments.', 'NO', '["NO","No","no"]'::jsonb),
('bac84eed-b8f8-4494-8ad6-72e1e56aea72', 'ba3b8170-bfac-464f-8b47-6e96a5aca976', 31,
 'Modern legal systems generally operate on the assumption that individuals possess free will.', 'YES', '["YES","Yes","yes"]'::jsonb),
('00090587-0670-4840-9924-8e53e5fb0f85', 'ba3b8170-bfac-464f-8b47-6e96a5aca976', 32,
 'Recent studies on complex life decisions have yielded the exact same neurological results as simple button-pressing tasks.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb);
...
('f9320d56-0d69-4024-a831-e384b7244fe0', 'ba648949-9961-4790-af50-c8e8aeb4ffc4', 3,
 ...
 true, '["epiphenomenon", "veto", "readiness potential", "fMRI", "justice", "illusion", "EEG", "rehabilitative"]'::jsonb);
