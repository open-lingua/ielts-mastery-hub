...
('ac2366ed-a8a1-4edf-8ba6-52d85cdbb856', '6dff3935-e517-4f40-aaca-32496958c583', 1,
 'Charles Pearson personally provided all the funding for the Metropolitan Railway.', 'FALSE', '["FALSE","False","false"]'::jsonb),
('857253a4-afd7-4156-a10f-49c9a63a0698', '6dff3935-e517-4f40-aaca-32496958c583', 2,
 'The cut-and-cover construction method severely disrupted street-level businesses.', 'TRUE', '["TRUE","True","true"]'::jsonb),
('7675e2bc-5a20-4aaf-b853-75586d1e4586', '6dff3935-e517-4f40-aaca-32496958c583', 3,
 'The first deep-level tube line was financially successful in its opening year.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb),
('9ab44ad9-0e9a-4c64-9d1e-1d56c6917325', '6dff3935-e517-4f40-aaca-32496958c583', 4,
 'The British government immediately encouraged citizens to use the Underground as air-raid shelters.', 'FALSE', '["FALSE","False","false"]'::jsonb);
...
('b022ab2b-41e6-48e9-a815-66fc23999103', '8bef554c-555e-4385-b66a-05cc62fd559f', 5,
 'Row 1', '',
 '[{"id":"h1","gapText":"Era","answer":""},{"id":"h2","gapText":"Initiative","answer":""},{"id":"h3","gapText":"Consequence / Detail","answer":""}]'::jsonb),
('b062d770-2cfd-4250-aac3-54d97e683127', '8bef554c-555e-4385-b66a-05cc62fd559f', 6,
 'Row 2', '',
 '[{"id":"c1","gapText":"1840s","answer":""},{"id":"c2","gapText":"Charles Pearson’s proposal","answer":""},{"id":"c3","gapText":"Aimed to address severe {{gap}}","answer":"traffic congestion"}]'::jsonb),
('25e5b763-5832-451f-bf68-a643d194e520', '8bef554c-555e-4385-b66a-05cc62fd559f', 7,
 'Row 3', '',
 '[{"id":"c4","gapText":"1863","answer":""},{"id":"c5","gapText":"Metropolitan Railway opens","answer":""},{"id":"c6","gapText":"Used the {{gap}} method","answer":"cut-and-cover"}]'::jsonb),
('7260ceb7-6d4f-4be0-9c4f-09b4822c98f2', '8bef554c-555e-4385-b66a-05cc62fd559f', 8,
 'Row 4', '',
 '[{"id":"c7","gapText":"1890s","answer":""},{"id":"c8","gapText":"Invention of the {{gap}} shield","answer":"tunneling"},{"id":"c9","gapText":"Allowed for deep-level lines","answer":""}]'::jsonb),
('493b8cb8-9467-4f53-b3b6-e07d3eab0f38', '8bef554c-555e-4385-b66a-05cc62fd559f', 9,
 'Row 5', '',
 '[{"id":"c10","gapText":"1900s","answer":""},{"id":"c11","gapText":"Investment by Charles Yerkes","answer":""},{"id":"c12","gapText":"Led to network unity and {{gap}}","answer":"electrification"}]'::jsonb);
...
('7836944b-0671-4ded-b0c1-276a90f559b4', '60123a92-f37a-4890-9c03-b92fb3190974', 10,
 'What source of power was used for the locomotives on the opening day in 1863?', 'steam', '[{"id":"1","text":"steam"},{"id":"2","text":"steam engines"}]'::jsonb),
('317af346-7115-4168-bde1-6d39d46de4e3', '60123a92-f37a-4890-9c03-b92fb3190974', 11,
 'What was installed in the early tunnels in an attempt to alleviate the smoke problem?', 'ventilation shafts', '[{"id":"1","text":"ventilation shafts"}]'::jsonb),
('3e0aa824-ebcd-48dd-9fb7-4195e9388496', '60123a92-f37a-4890-9c03-b92fb3190974', 12,
 'What primary alternative function did underground stations serve during the Blitz?', 'air-raid shelters', '[{"id":"1","text":"air-raid shelters"},{"id":"2","text":"refuge"}]'::jsonb),
('581df9ef-4387-4872-9d6a-bb6e723546fe', '60123a92-f37a-4890-9c03-b92fb3190974', 13,
 'Which contemporary infrastructure project has notably transformed travel times in London?', 'Elizabeth line', '[{"id":"1","text":"Elizabeth line"},{"id":"2","text":"the Elizabeth line"}]'::jsonb);
...
('5cfd1c58-9e8a-404d-801b-1c6c5a57612c', '1c84e1e0-9676-4a81-94b9-941eff7e2e89', 24,
 ...
 'B',
 '[{"id":"A","text":"A. The high ceilings reduce the need for reverberation time.","isCorrect":false},{"id":"B","text":"B. It provides strong lateral sound reflections to the audience.","isCorrect":true},{"id":"C","text":"C. It allows for more democratic and visually intimate seating.","isCorrect":false},{"id":"D","text":"D. It limits the blending of large symphonic instruments.","isCorrect":false}]'::jsonb),
...
('9349df9b-ed4d-44e7-b710-2257c020d3aa', '1c84e1e0-9676-4a81-94b9-941eff7e2e89', 26,
 ...
 'A',
 '[{"id":"A","text":"A. Different genres of music require different optimal RTs.","isCorrect":true},{"id":"B","text":"B. A long RT is always preferable to a short RT.","isCorrect":false},{"id":"C","text":"C. RT was primarily used to fix the Fogg Art Museum.","isCorrect":false},{"id":"D","text":"D. A short RT helps blend the sound of large symphonic works.","isCorrect":false}]'::jsonb),
('75511a7b-0c6b-4c32-977c-dba41e739e57', '1c84e1e0-9676-4a81-94b9-941eff7e2e89', 27,
 ...
 'D',
 '[{"id":"A","text":"A. Computer modeling will eventually make physical testing obsolete.","isCorrect":false},{"id":"B","text":"B. The shoebox design is no longer relevant for modern orchestras.","isCorrect":false},{"id":"C","text":"C. Visual aesthetics are more important than physical acoustics.","isCorrect":false},{"id":"D","text":"D. It remains a complex blend of objective science and subjective perception.","isCorrect":true}]'::jsonb);
...
('c7371fba-dd94-497b-9015-069273d33baa', 'ce7b9736-e3a7-4d4b-86db-79a5b90e7979', 28,
 'Engaging in play behavior reduces an animal’s risk of being attacked by predators.', 'NO', '["NO","No","no"]'::jsonb),
('ce847d51-33d7-41ca-9905-3f67a38ee9f4', 'ce7b9736-e3a7-4d4b-86db-79a5b90e7979', 29,
 'Gordon Burghardt established a widely accepted framework for defining animal play.', 'YES', '["YES","Yes","yes"]'::jsonb),
('1492b42c-4676-42a3-b324-fcd9dd0dd96e', 'ce7b9736-e3a7-4d4b-86db-79a5b90e7979', 30,
 'Meerkat pups that play more frequently become more successful hunters as adults.', 'NO', '["NO","No","no"]'::jsonb),
('e43764ff-3247-45e2-838f-22667df3bec6', 'ce7b9736-e3a7-4d4b-86db-79a5b90e7979', 31,
 'Male animals generally spend a greater proportion of their time playing than female animals.', 'NOT GIVEN', '["NOT GIVEN","Not Given","not given"]'::jsonb);
...
('cbfeb7a1-0323-4fdb-be42-ec84d8507041', '328fb7f9-790f-4901-ae1b-d5f392986aad', 35,
 ...
 'D',
 '[{"id":"A","text":"develop crucial physical skills needed for adulthood.","isCorrect":false},{"id":"B","text":"practice recovering from sudden or stressful situations.","isCorrect":false},{"id":"C","text":"establish and maintain complex social hierarchies.","isCorrect":false},{"id":"D","text":"are motivated to participate despite the survival risks.","isCorrect":true},{"id":"E","text":"consume excess calories in an environment with abundant food.","isCorrect":false},{"id":"F","text":"differentiate between true aggression and harmless interaction.","isCorrect":false}]'::jsonb);
...
('dde76efb-00f2-4464-be48-d3a431ae08ce', '2a354f99-1602-43d1-94ae-aea1af1673a6', 3,
 ...
 true, '["preparation", "vulnerable", "recover", "emergencies", "dopamine", "calories", "hierarchies", "aggression", "predators"]'::jsonb);
